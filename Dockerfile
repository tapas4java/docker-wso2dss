...
ENV DSS_VERSION 3.5.0

WORKDIR "/opt"

# ESB Setup
COPY Packages/wso2dss-${DSS_VERSION}.zip /opt
RUN unzip /opt/wso2dss-${DSS_VERSION}.zip 
RUN chmod +x /opt/wso2dss-${DSS_VERSION}/bin/wso2server.sh
